...
function draw() {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        let r = random(0.2, 15); // Random radius for the star, smaller values for more distant stars
        //let hue = random(360); // Random hue for color variation (used for our HSB)
        
        fill(60, 0, 100); // Set fill color with random hue and some saturation and brightness
