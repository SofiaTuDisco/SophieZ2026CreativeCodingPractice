...
function preload() {
    ...
    img = loadImage('data/glitchblackwall.png');
...
function draw() {
    ...
    // Glitchy text effect - appears every 200 frames
    if (frameCount % 20 === 0) {
        // Array indexing with random() for text selection
        // floor() converts random decimal to integer index
        let glitchText = ['TO', 'KILL ', 'A', 'Ch iN eSE', 'HiPsT ER ','millenial'][floor(random(0, 5))];
