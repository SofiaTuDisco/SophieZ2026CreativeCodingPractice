...
function preload() {
  ...
  for (let i = 0; i < 2; i++) {
    ...
    myFont = loadFont ('data/Chomsky.otf');
  }
}
...
function setup() {
  ...
  layer2Items = generateCollageItems(layer2Images, 2, width / 3, height / 3, width / 3, height / 4, 0.2, 1.0, -HALF_PI, HALF_PI);
  layer3Items = generateCollageItems(layer3Images, 3, width / 2, height / 2, width / 2, height, 0.4, 0.8, PI, HALF_PI);
  layer4Items = generateCollageItems(layer4Images, 4, width / 2, height / 2, width / 2, height, 0.4, 0.8, PI, HALF_PI);
...
function draw() {
  ...
  //textFont(myFont)
  //fill(255,0,0,120);
  //text("To Kill a Chinese Hipster", width/2 + 3, 303);
  //fill(255,0,0);
  //text("To Kill a Chinese Hipster", width/2, 300);
