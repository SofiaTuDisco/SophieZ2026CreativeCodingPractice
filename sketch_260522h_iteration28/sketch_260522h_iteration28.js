...
function preload() {
  ...
  bgImage = loadImage("data/AdobeStock_190848037.png");  
}
...
pop();
 ...
 // pop(); // Restore position/rotation before drawing the next shape
  ...
  pop();
    ...
    push();
    //translate(20, -20, 100); // Right, slightly up, and back into the scene
    // OPTIONAL ORBIT VERSION: comment out the line above and uncomment below.
    translate(cos(frameCount * 0.08) * -240, 20, sin(frameCount * 0.02) * 2240);
    noStroke();
    fill(255, 255, 0);
    sphere(30); // A sphere — the one argument is the radius
  pop();
     ...
     push();
    //translate(-200, -20, 100); // Right, slightly up, and back into the scene
    // OPTIONAL ORBIT VERSION: comment out the line above and uncomment below.
    translate(cos(frameCount * 0.2) * 240, -20, sin(frameCount * 0.04) * 1240);
    noStroke();
    fill(0, 0, 255);
    sphere(30); // A sphere — the one argument is the radius
  pop();
