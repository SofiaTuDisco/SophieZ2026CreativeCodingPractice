...
function setup() {
  ...
  layer1Items = generateCollageItems(layer1Images, 8, width / 2, height / 2, width / 3, height / 4, 0.5, 1.5, 0, PI);
  layer2Items = generateCollageItems(layer2Images, 12, width / 2, height / 2, width / 2, height / 3, 0.2, 1.0, -HALF_PI, HALF_PI);
  layer3Items = generateCollageItems(layer3Images, 16, width / 2, height / 2, width / 2, height, 0.4, 0.8, PI, HALF_PI);
