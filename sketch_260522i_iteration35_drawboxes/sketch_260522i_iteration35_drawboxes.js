...
function draw() {
  ...
  stroke(255, 255, 255);   // Make the outline red (Red, Green, Blue)
  strokeWeight(2);    // Make the outline 10 pixels thick
  ...
  if (mouseIsPressed) {
    ...
    fill(255, 0, 0); // Fill the square with yellow
  } else {
    // If the mouse button is NOT being held down...
    fill(255, 255, 255);   // Fill the square with blue
  }
